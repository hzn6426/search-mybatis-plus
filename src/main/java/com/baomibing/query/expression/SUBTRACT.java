...
public class SUBTRACT extends Expression {
    ...
    public <T> SUBTRACT(SFunction<T, ?> propertyFunction, Number value) {
        this.fieldPart = new Field<>(propertyFunction);
        this.operator = Operator.SUB.getOp();
        this.value = value;
    }
    
    public <T> SUBTRACT(Alias alias, Number value) {
    ...
    @Override
    public String toSQL() {
        return this.fieldPart.toSQL() + OP_SUBTRACT + value;
    }
}
