...
public class LTE extends ACondition {
	...
	private LTE(boolean beTrue, SelectablePart field, Object value, boolean beValueFun) {
		if (beTrue) {
	...
	public LTE(FieldPart field, Object value) {
		this(true, field, value, true);
	}
	
	public LTE(boolean beTrue, FieldPart field, Object value) {
		this(beTrue, field, value ,true);
	}
	
	public <T1> LTE(SFunction<T1, ?> propertyFunction, Object value) {
	...
	public <T1, T2> LTE(SFunction<T1, ?> propertyFunction, SQLFunction sqlFunction) {
	...
	public <T1> LTE(SFunction<T1, ?> propertyFunction, Expression expression) {
	...
	public <T1> LTE(boolean beTrue, SFunction<T1, ?> propertyFunction, Object value) {
	...
	public <T1, T2> LTE(boolean beTrue, SFunction<T1, ?> propertyFunction, SQLFunction sqlFunction) {
	...
	public <T1> LTE(boolean beTrue, SFunction<T1, ?> propertyFunction, Expression expression) {
	...
	public String toSQL() {
		...
		s.append(selectablePart.toSQL()).append(OP_LTE).append(beValueFun ? displayValue(value) : value);
		return s.toString();
	}
